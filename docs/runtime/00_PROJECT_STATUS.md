...
| Statut | **ACTIF** |
| Dernière mise à jour | 5 août 2026 — MVP-001 |
...
| Phase | Développement MVP — socle Frontend (MVP-001) |
| Statut global | Conception close ; Runtime 20/20 ; App Shell livré dans `web/` ; **aucune** `F-xxx` métier terminée |
...
| Développement | **En cours** | Socle `web/` (Next.js) + App Shell ; ticket MVP-001 |
| Tests | **Non commencé** | Build/lint/tsc OK en local ; aucune campagne de test produit (`09`) |
...
| Cohérence conception ↔ runtime | Non évaluable côté code (aucun code) ; sync post-Freeze documentaire effectuée (audit → corrections C1/C2/C3/M4) |
...
| --- | --- |
| Tickets ouverts | 0 |
| Tickets terminés | 1 (MVP-001) |
| Tickets bloqués | 0 |
| Modules applicatifs commencés | App Shell Frontend (`web/`) |
...
| Fonctionnalités en cours | **Aucune** |
| Fonctionnalités restantes | **41 / 41** catalogue (`02_FEATURE_STATUS`) ; dont 19 MVP+Pré-MVP — **toutes non commencées** |

Aucune fonctionnalité `F-xxx` n’est marquée terminée : aucun code ne les implémente. Détail : `02_FEATURE_STATUS.md`.
...
| Changements Runtime (`17`) | **1** `CH-001` (MVP-001) |
...
| Domaine | État réel |
| --- | --- |
| Architecture | Spécifiée ; registre `01` ; Frontend **en cours** (shell) ; reste non implémenté |
...
| `00_PROJECT_STATUS.md` | Tableau de bord | **ACTIF** | 5 août 2026 |
| `01_ARCHITECTURE_STATUS.md` | Architecture réelle | **ACTIF** | 5 août 2026 |
| `02_FEATURE_STATUS.md` | Features réelles | **ACTIF** | 5 août 2026 |
| `03_DATA_STATUS.md` | Data réelle | **ACTIF** | 5 août 2026 |
...
| `07_OFFLINE_STATUS.md` | Offline réel | **ACTIF** | 5 août 2026 |
| `08_ANALYTICS_STATUS.md` | Analytics réel | **ACTIF** | 5 août 2026 |
| `09_TEST_STATUS.md` | Tests réels | **ACTIF** | 5 août 2026 |
...
| `17_CHANGE_HISTORY.md` | Historique changements | **ACTIF** | 5 août 2026 |
...
1. Ouvrir le prochain ticket MVP (contenu / pratique — hors shell).  
...
flowchart LR
  ...
  RT[Runtime Complet]
  DEV[Développement Non commencé]
