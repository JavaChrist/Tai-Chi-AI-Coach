...
| Phase | Développement MVP — progression / historique local (MVP-006) |
| Statut global | Conception close ; Runtime 20/20 ; pratique + historique localStorage ; **F-009** / **F-010** / **F-013** / **F-032** en cours ; **aucune** `F-xxx` Validé/Livré ; pas de sync |
...
| Développement | **En cours** | Socle + pratique + progression locale `/progression` (MVP-006) |
| Tests | **En cours** | Vitest : **26** tests OK ; pas de campagne produit complète |
...
| Cohérence conception ↔ runtime | Sync post-Freeze documentaire effectuée ; runtime applicatif partiel (+ progression localStorage) |
...
| --- | --- |
| Tickets ouverts | 0 |
| Tickets terminés | 6 (MVP-001 … MVP-006) |
| Tickets bloqués | 0 |
| Modules applicatifs commencés | App Shell + DS + curriculum + assets + pratique + progression locale (`web/`) |
...
| Fonctionnalités en cours | **4** (`F-009`, `F-010`, `F-013`, `F-032`) |
| Fonctionnalités restantes | **37** non commencées (`02_FEATURE_STATUS`) |
...
| Changements Runtime (`17`) | **6** `CH-001`…`CH-006` (MVP-001…MVP-006) |
...
| Domaine | État réel |
| --- | --- |
| Architecture | Spécifiée ; registre `01` ; Frontend **en cours** (+ progression localStorage) ; Offline/PWA non implémentés |
...
| `00_PROJECT_STATUS.md` | Tableau de bord | **ACTIF** | 5 août 2026 — MVP-006 |
| `01_ARCHITECTURE_STATUS.md` | Architecture réelle | **ACTIF** | 5 août 2026 — MVP-005 |
| `02_FEATURE_STATUS.md` | Features réelles | **ACTIF** | 5 août 2026 — MVP-006 |
| `03_DATA_STATUS.md` | Data réelle | **ACTIF** | 5 août 2026 — MVP-006 |
...
| `07_OFFLINE_STATUS.md` | Offline réel | **ACTIF** | 5 août 2026 — MVP-006 |
| `08_ANALYTICS_STATUS.md` | Analytics réel | **ACTIF** | 5 août 2026 |
| `09_TEST_STATUS.md` | Tests réels | **ACTIF** | 5 août 2026 — MVP-006 |
...
| `17_CHANGE_HISTORY.md` | Historique changements | **ACTIF** | 5 août 2026 — CH-006 |
...
1. Ouvrir le prochain ticket MVP (médias, auth, sync, ou dépôt assets finaux par le PO).  
