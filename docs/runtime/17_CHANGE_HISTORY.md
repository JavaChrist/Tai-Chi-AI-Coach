...
| CH-021 | Offline / PWA cache cœur — SW unique étendu ; precache + runtime ; `/hors-ligne` ; vidéos Network Only ; App Update préservé | MVP-017 | `00`, `01`, `07`, `09`, `11`, `17` | — | 9 août 2026 | Appliqué — MVP-017 fermé — commit `b5acc1b` |
...
| 9 août 2026 | CH-021 — MVP-017 Offline/PWA cache cœur (`b5acc1b`) ; MVP-017 **fermé** (validation PO) ; Offline Livré ; iPhone/Safari → MVP-018 ; MVP-012 MEDIA BLOCKED ; MVP-018 non ouvert. |
