...
| Statut | **ACTIF** |
| Dernière mise à jour | 8 août 2026 — MVP-013 fermé / BeginnerPath local |
...
| Curriculum | D3 | En développement | MVP-003 / MVP-011 / MVP-013 | 8 août 2026 | Sessions + Movement + `movementIds` ; **BeginnerPath** local (`orderedSessionIds` — F-003 Livré) ; pas SQL ; pas de progression path persistante |
